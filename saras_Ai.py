from streamlit import image,title,text_input,write,header
import numpy as np
...
image("saras logo.jpeg", width=700)
title("Saras AI - FAQ Search System")
write("Ask a question to find relevant answers:")

user_query = text_input("Enter your query:")

if user_query:
    matches = word_similarities_glove(user_query)
    header("Top 5 FAQs based on your query are:")
